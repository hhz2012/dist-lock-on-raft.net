...
{
    public class ShardEmulator:IRaftComSender,IWarningLog
    {
        ...
        public void StartEmulateTcpNodes(int nodesQuantity)
        {
            ...
            Console.WriteLine("start a shard node");
            for(int i = 0;i< nodesQuantity;i++)
                eps.Add(new TcpClusterEndPoint() { Host = "127.0.0.1", Port = portStart + i });
